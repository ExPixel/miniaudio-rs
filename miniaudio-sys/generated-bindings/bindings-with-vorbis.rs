...
pub const MA_VERSION_REVISION: u32 = 15;
pub const MA_TRUE: u32 = 1;
pub const MA_FALSE: u32 = 0;
pub const MA_SIZE_MAX: i32 = -1;
...
pub type ma_int8 = i8;
pub type ma_uint8 = u8;
pub type ma_int16 = i16;
pub type ma_uint16 = u16;
pub type ma_int32 = i32;
pub type ma_uint32 = u32;
pub type ma_int64 = i64;
pub type ma_uint64 = u64;
pub type ma_uintptr = usize;
...
impl ::core::fmt::Debug for ma_lpf {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        write ! ( f , "ma_lpf {{ format: {:?}, channels: {:?}, lpf1Count: {:?}, lpf2Count: {:?}, lpf1: {:?}, lpf2: {:?} }}" , self . format , self . channels , self . lpf1Count , self . lpf2Count , self . lpf1 , self . lpf2 )
    }
}
extern "C" {
...
impl ::core::fmt::Debug for ma_hpf {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        write ! ( f , "ma_hpf {{ format: {:?}, channels: {:?}, hpf1Count: {:?}, hpf2Count: {:?}, hpf1: {:?}, hpf2: {:?} }}" , self . format , self . channels , self . hpf1Count , self . hpf2Count , self . hpf1 , self . hpf2 )
    }
}
extern "C" {
...
pub struct ma_context__bindgen_ty_1__bindgen_ty_2 {
    ...
    pub pApplicationName: *mut libc::c_char,
...
impl ::core::fmt::Debug for ma_device__bindgen_ty_3 {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        write ! ( f , "ma_device__bindgen_ty_3 {{ name: [...], shareMode: {:?}, usingDefaultFormat : {:?}, usingDefaultChannels : {:?}, usingDefaultChannelMap : {:?}, format: {:?}, channels: {:?}, channelMap: [...], internalFormat: {:?}, internalChannels: {:?}, internalSampleRate: {:?}, internalChannelMap: [...], internalPeriodSizeInFrames: {:?}, internalPeriods: {:?}, converter: {:?} }}" , self . shareMode , self . usingDefaultFormat ( ) , self . usingDefaultChannels ( ) , self . usingDefaultChannelMap ( ) , self . format , self . channels , self . internalFormat , self . internalChannels , self . internalSampleRate , self . internalPeriodSizeInFrames , self . internalPeriods , self . converter )
    }
}
...
impl ma_device__bindgen_ty_4__bindgen_ty_1 {
    ...
    #[inline]
    pub fn set_isUsingMMapPlayback(&mut self, val: ma_bool32) {
        unsafe {
            let val: u32 = ::core::mem::transmute(val);
            self._bitfield_1.set(0usize, 1u8, val as u64)
        }
    ...
    #[inline]
    pub fn isUsingMMapCapture(&self) -> ma_bool32 {
        unsafe { ::core::mem::transmute(self._bitfield_1.get(1usize, 1u8) as u32) }
    }
    #[inline]
    pub fn set_isUsingMMapCapture(&mut self, val: ma_bool32) {
        unsafe {
            let val: u32 = ::core::mem::transmute(val);
            self._bitfield_1.set(1usize, 1u8, val as u64)
        }
    ...
    #[inline]
    pub fn new_bitfield_1(
        isUsingMMapPlayback: ma_bool32,
        isUsingMMapCapture: ma_bool32,
    ) -> __BindgenBitfieldUnit<[u8; 1usize], u8> {
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize], u8> =
            Default::default();
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            let isUsingMMapPlayback: u32 = unsafe { ::core::mem::transmute(isUsingMMapPlayback) };
            isUsingMMapPlayback as u64
        });
        __bindgen_bitfield_unit.set(1usize, 1u8, {
            let isUsingMMapCapture: u32 = unsafe { ::core::mem::transmute(isUsingMMapCapture) };
            isUsingMMapCapture as u64
        });
        __bindgen_bitfield_unit
    }
}
...
pub struct ma_device__bindgen_ty_4__bindgen_ty_2 {
    ...
    pub pMappedBufferPlayback: *mut libc::c_void,
    pub pMappedBufferCapture: *const libc::c_void,
...
impl ma_device__bindgen_ty_4__bindgen_ty_2 {
    ...
    #[inline]
    pub fn set_breakFromMainLoop(&mut self, val: ma_bool32) {
        unsafe {
            let val: u32 = ::core::mem::transmute(val);
            self._bitfield_1.set(0usize, 1u8, val as u64)
        }
    ...
    #[inline]
    pub fn new_bitfield_1(breakFromMainLoop: ma_bool32) -> __BindgenBitfieldUnit<[u8; 1usize], u8> {
        let mut __bindgen_bitfield_unit: __BindgenBitfieldUnit<[u8; 1usize], u8> =
            Default::default();
        __bindgen_bitfield_unit.set(0usize, 1u8, {
            let breakFromMainLoop: u32 = unsafe { ::core::mem::transmute(breakFromMainLoop) };
            breakFromMainLoop as u64
        });
        __bindgen_bitfield_unit
    }
}
...
extern "C" {
    pub fn ma_apply_volume_factor_u8(pSamples: *mut ma_uint8, sampleCount: ma_uint32, factor: f32);
}
extern "C" {
    pub fn ma_apply_volume_factor_s16(pSamples: *mut ma_int16, sampleCount: ma_uint32, factor: f32);
}
extern "C" {
...
extern "C" {
    pub fn ma_apply_volume_factor_s32(pSamples: *mut ma_int32, sampleCount: ma_uint32, factor: f32);
}
extern "C" {
    pub fn ma_apply_volume_factor_f32(pSamples: *mut f32, sampleCount: ma_uint32, factor: f32);
}
extern "C" {
...
pub type ma_resource_format = u32;
...
fn bindgen_test_layout_ma_decoder() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<ma_decoder>())).readPointer as *const _ as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(ma_decoder),
            "::",
            stringify!(readPointer)
        )
    );
    assert_eq!(
